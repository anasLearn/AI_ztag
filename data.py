...
resolution = 10 # how many steps of simulation in one second
effect_distance = 1 # The distance under which the interactions between players happen in meters
effect_time = 1 # how much time the players has to be next to each other to produce an effect
...
speed_range = (3, 7) # Possible range of speed of players in m/s, the speed of each player is picked up randomly from this range
