...
speed_range = (2, 8) # Possible range of speed of players in m/s, the speed of each player is picked up randomly from this range
safe_period = 3 #Safe period after infection (like in super mario) 
cool_period = (5, 20) #cool period of the checkpoints
zombie_stop = 10 #period in the beginning of the game when zombies can't move
